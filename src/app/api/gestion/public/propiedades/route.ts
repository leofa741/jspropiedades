  ...
  try {
    ...
    const sanitizeProperty = (prop: any) => {
      ...
      return {
        ...
        precio: prop.tipoOperacion === 'alquiler' 
          ? { monto: precios.alquiler?.monto, moneda: precios.alquiler?.moneda, tipo: 'alquiler' }
          : { monto: precios.venta?.monto, moneda: precios.venta?.moneda, tipo: 'venta' },
